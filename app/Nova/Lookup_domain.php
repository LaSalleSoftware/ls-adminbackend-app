 ...
 * @package App\Nova
 */
class Lookup_domain extends BaseResource
{
    /**
     ...
     * @var string
     */
    public static $model = 'Lasallesoftware\\Library\\Profiles\\Models\\Lookup_domain';
    ...
    {
        return __('lasallesoftwarelibrary::general.resource_label_plural_lookup_domains');
    }
    ...
    {
        return __('lasallesoftwarelibrary::general.resource_label_singular_lookup_domains');
    }
    ...
    public function fields(Request $request)
    {
        return [
            ...
            LookupTitle::make('title')
                ->creationRules('unique:lookup_domains,title')
                ->updateRules('unique:lookup_domains,title,{{resourceId}}'),
