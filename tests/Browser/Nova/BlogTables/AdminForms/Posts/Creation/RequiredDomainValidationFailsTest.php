...
class RequiredDomainValidationFailsTest extends BlogTablesBaseDuskTestCase
{
     ...
     * @group novablogtablesadminformspostscreationrequireddomainvalidationfails
     */
    public function testRequiredDomainValidationFails()
    {
