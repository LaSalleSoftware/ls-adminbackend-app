...
namespace Tests\Browser\Nova\BlogTables\AdminForms\Tags\Details;
...
class IsSuccessfulTest extends BlogTablesBaseDuskTestCase
{
     ...
     * @group novablogtablesadminformstagsdetails
     * @group novablogtablesadminformstagsdetailsissuccessful
     */
    public function testDetailsIsSuccessful()
    {
        echo "\n**Now testing Tests\Browser\Nova\BlogTables\AdminForms\Tags\Details\TestDetailsIsSuccessful**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->assertPathIs('/nova/resources/tags/1')
