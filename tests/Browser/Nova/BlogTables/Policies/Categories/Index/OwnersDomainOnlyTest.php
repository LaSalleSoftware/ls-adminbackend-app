...
class OwnersDomainOnlyTest extends BlogTablesBaseDuskTestCase
{
    ...
    /**
     * Test that the owners see a list with all categories.
     *
     ...
     * @group NovaBlogtablesPoliciesCategoriesIndexOwnersdomainonly
     */
    public function testOwnersDomainOnly()
    {
        echo "\n**Now testing Tests\Browser\Nova\BlogTables\Policies\Categories\Index\TestOwnersDomainOnly**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->assertSee('Music')
                ->assertSee('Sports')
                ->assertSee('Music For Domain 2')
                ->assertSee('Sports For Domain 2')
                ->assertSee('Music For Domain 3')
                ->assertSee('Sports For Domain 3')
            ;
        });
    }
}
