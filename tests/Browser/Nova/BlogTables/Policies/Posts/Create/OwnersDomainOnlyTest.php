...
class OwnersDomainOnlyTest extends BlogTablesBaseDuskTestCase
{
    ...
    /**
     * Test that the an owner can create posts
     *
     * @group nova
     ...
     * @group NovaBlogtablesPoliciesPostsCreateOwnersdomainonly
     */
    public function testOwnersDomainOnly()
    {
        echo "\n**Now testing Tests\Browser\Nova\BlogTables\Policies\Posts\Create\TestOwnersDomainOnly**";
