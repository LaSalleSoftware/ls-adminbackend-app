...
class AdminsDomainOnlyTest extends BlogTablesBaseDuskTestCase
{
    ...
    /**
     * Test that the an admin can see only posts that they authored.
     *
     ...
     * @group NovaBlogtablesPoliciesPostsIndexAdminsdomainonly
     */
    public function testAdminsDomainOnly()
    {
        echo "\n**Now testing Tests\Browser\Nova\BlogTables\Policies\Posts\Index\TestAdminsDomainOnly**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->assertDontSee('Biography Of Blues Boy King On Domain 1')
                ->assertDontSee('Biography Of Robert Johnson On Domain 1')
