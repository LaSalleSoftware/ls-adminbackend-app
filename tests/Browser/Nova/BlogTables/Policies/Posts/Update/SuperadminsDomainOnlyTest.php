...
class SuperadminsDomainOnlyTest extends BlogTablesBaseDuskTestCase
{
    ...
    /**
     * Test that the a super admin can update only posts that belong to their domain.
     *
     * @group nova
     ...
     * @group NovaBlogtablesPoliciesPostsUpdateSuperadminsdomainonly
     */
    public function testIndexListingListsSuperadminsDomainOnly()
    {
        echo "\n**Now testing Tests\Browser\Nova\BlogTables\Policies\Posts\Update\TestSuperadminsDomainOnly**";
