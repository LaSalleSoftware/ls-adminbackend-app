...
namespace Tests\Browser\Nova\BlogTables\Policies\Tags\Update;
...
class SuperadminsDomainOnlyTest extends BlogTablesBaseDuskTestCase
{
    ...
    /**
     * Test that the a super admin can update only tags that belong to their domain.
     *
     * @group nova
     * @group novablogtables
     * @group NovaBlogtablesPolicies
     * @group NovaBlogtablesPoliciesTags
     * @group NovaBlogtablesPoliciesTagsUpdate
     * @group NovaBlogtablesPoliciesTagsUpdateSuperadminsdomainonly
     */
    public function testIndexListingListsSuperadminsDomainOnly()
    {
        echo "\n**Now testing Tests\Browser\Nova\BlogTables\Policies\Tags\Update\TestSuperadminsDomainOnly**";
