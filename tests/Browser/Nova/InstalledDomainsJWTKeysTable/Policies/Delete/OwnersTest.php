...
namespace Tests\Browser\Nova\InstalledDomainsJWTKeysTable\Policies\Delete;
...
class OwnersTest extends InstalledDomainsTableBaseDuskTestCase
{
    ...
    /**
     * Test that the an owner can see the delete icons.
     *
     ...
     * @group NovaInstalleddomainsjwtkeystablePoliciesDelete
     */
    public function testSeeTheDeleteButton()
    {
        echo "\n**Now testing Tests\Browser\Nova\InstalledDomainsJWTKeysTable\Policies\Delete\OwnersTest**";
