...
class AdminsTest extends InstalledDomainsTableBaseDuskTestCase
{
    ...
    /**
     * Test that the an admins cannot see the menu
     *
     * @group nova
     ...
     * @group NovaInstalleddomainsjwtkeystablePoliciesMenuAdmins
     */
    public function testNotSeeTheMenu()
    {
        echo "\n**Now testing Tests\Browser\Nova\InstalledDomainsJWTKeysTable\Policies\Menu\AdminsTest**";
