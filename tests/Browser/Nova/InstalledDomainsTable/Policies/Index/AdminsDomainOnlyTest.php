...
class AdminsDomainOnlyTest extends InstalledDomainsTableBaseDuskTestCase
{
    ...
    /**
     * If the admin goes to /nova/resources/installed_domains, then will see a screen but no database recrods.
     *
     ...
     * @group NovaInstalleddomainstablePoliciesIndexAdminsdomainonly
     */
    public function testAdminsDomainOnly()
    {
        echo "\n**Now testing Tests\Browser\Nova\InstalledDomainsTable\Policies\Index\TestAdminsDomainOnly**";
