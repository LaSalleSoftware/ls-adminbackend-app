...
class AdminsDomainOnlyTest extends InstalledDomainsTableBaseDuskTestCase
{
    ...
    /**
     * Test that the an admin cannot access the update form directly.
     *
     * @group nova
     * @group NovaInstalleddomainstable
     * @group NovaInstalleddomainstablePolicies
     * @group NovaInstalleddomainstablePoliciesView
     * @group NovaInstalleddomainstablePoliciesViewAdminsdomainonly
     */
    public function testAdminsDomainOnly()
    {
        echo "\n**Now testing Tests\Browser\Nova\InstalledDomainsTable\Policies\View\TestAdminsDomainOnly**";
