...
namespace Tests\Browser\Nova\LoginsTable\Policies\View;
...
class OwnersTest extends LoginsTableBaseDuskTest
{
    ...
    /**
     * Owners can view logins.
     *
     * @group nova
     * @group novaLogin
     * @group novaLoginPolicies
     * @group novaLoginPoliciesView
     * @group novaLoginPoliciesViewOwners
     */
    public function testOwners()
    {
        echo "\n**Now testing Tests\Browser\Nova\LoginsTable\Policies\View\TestOwners**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($personTryingToLogin, $pause) {
            $browser
                ...
                // All four view buttons should be visible
