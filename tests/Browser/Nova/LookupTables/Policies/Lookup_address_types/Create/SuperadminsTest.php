...
class SuperadminsTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookupaddresstypesCreateSuperadmins
     */
    public function testIndexListingListsSuperadmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookupaddresstypes\Create\TestSuperadmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->visit('/nova/resources/lookup_address_types/new?viaResource=&viaResourceId=&viaRelationship=')
                ->pause($pause['medium'])
