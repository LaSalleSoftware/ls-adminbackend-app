...
class SuperadminsTest extends LookupTablesBaseDuskTestCase
{
    ...
    /**
     * Test that the a super admin can see lookup_address_types.
     *
     ...
     * @group novaLookuptablesPoliciesLookupaddresstypesIndexSuperadmins
     */
    public function testIndexListingListsSuperadmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\Lookuptables\Policies\Lookupaddresstypes\Index\TestSuperadmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->assertDontSee('Lookup Address Types')         // Superadmins and Admins do not see lookup tables
