...
class OwnersTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookupemailtypesCreateOwners
     */
    public function testOwners()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookupemailtypes\Create\TestOwners**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->clickLink('Create Lookup Email Type')
                ->pause($pause['long'])
                ->assertSee('Create Lookup Email Type')
            ;
        });
