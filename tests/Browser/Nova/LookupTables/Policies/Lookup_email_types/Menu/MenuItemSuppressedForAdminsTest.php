...
namespace Tests\Browser\Nova\LookupTables\Policies\Lookup_email_types\Menu;
...
class MenuItemSuppressedForAdminsTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookupemailtypesMenu
     * @group novaLookuptablesPoliciesLookupemailtypesMenuitemsuppressedforadmins
     */
    public function testMenuItemSuppressedForAdminsIsSuccessful()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookupemailtypes\Menu\TestMenuItemSuppressedForAdminsIsSuccessful**";
