...
namespace Tests\Browser\Nova\LookupTables\Policies\Lookup_email_types\View;
...
class SuperadminsTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookupemailtypesView
     * @group novaLookuptablesPoliciesLookupemailtypesViewSuperadmins
     */
    public function testIndexListingListsSuperadmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookupemailtypes\View\TestSuperadmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->visit('/nova/resources/Lookup_email_types/5')
                ->pause($pause['short'])
