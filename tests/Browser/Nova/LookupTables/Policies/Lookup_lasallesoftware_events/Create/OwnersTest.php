...
class OwnersTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookuplasallesoftwareeventsCreateOwners
     */
    public function testOwners()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookuplasallesoftwareevents\Create\TestOwners**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->clickLink('Create Lookup LaSalle Software Event')
                ->pause($pause['medium'])
                ->assertSee('Create Lookup LaSalle Software Event')
            ;
        });
