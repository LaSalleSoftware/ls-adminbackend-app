...
namespace Tests\Browser\Nova\LookupTables\Policies\Lookup_lasallesoftware_events\Menu;
...
class MenuItemSuppressedForAdminsTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookuplasallesoftwareeventsMenu
     * @group novaLookuptablesPoliciesLookuplasallesoftwareeventsMenuitemsuppressedforadmins
     */
    public function testMenuItemSuppressedForAdminsIsSuccessful()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookuplasallesoftwareevents\Menu\TestMenuItemSuppressedForAdminsIsSuccessful**";
