...
namespace Tests\Browser\Nova\LookupTables\Policies\Lookup_roles\Create;
...
class OwnersTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookuprolesCreate
     * @group novaLookuptablesPoliciesLookuprolesCreateOwners
     */
    public function testOwners()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookuproles\Create\TestOwners**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->clickLink('Create Lookup User Role')
                ->pause($pause['medium'])
                ->assertSee('Create Lookup User Role')
            ;
        });
