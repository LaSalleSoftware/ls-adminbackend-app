...
class Adminsest extends LookupTablesBaseDuskTestCase
{
    ...
    /**
     * Test that the an admin cannot see Lookup_roles.
     *
     ...
     * @group novaLookuptablesPoliciesLookuprolesIndexAdmins
     */
    public function testAdmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookuproles\Index\TestAdmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->assertPathIs('/nova')
                ->assertSee('Dashboard')
                ->assertDontSee('Lookup User Roles')         // Superadmins and Admins do not see lookup tables
                ->visit('/nova/resources/Lookup_roles')
                ->pause($pause['long'])
                ->assertDontSee('Create Lookup User Role')
