...
namespace Tests\Browser\Nova\LookupTables\Policies\Lookup_roles\Personbydomain\Detach;
...
class SuppressDetachButtonTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookuprolesPersonbydomainDetach
     * @group novaLookuptablesPoliciesLookuprolesPersonbydomainDetachSuppressdetachbutton
     */
    public function testSuppressDetachButton()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookuproles\Personbydomain\Detach\TestSuppressDetachButton**";
