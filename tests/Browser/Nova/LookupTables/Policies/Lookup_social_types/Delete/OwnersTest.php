...
class OwnersTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookupsocialtypesDeleteOwners
     */
    public function testOwners()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookupsocialtypes\Delete\TestOwners**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->assertMissing('@10-delete-button')
                ->assertMissing('@11-delete-button')
                ->assertMissing('@12-delete-button')

                ->assertVisible('@13-delete-button')
            ;
        });
    }
}
