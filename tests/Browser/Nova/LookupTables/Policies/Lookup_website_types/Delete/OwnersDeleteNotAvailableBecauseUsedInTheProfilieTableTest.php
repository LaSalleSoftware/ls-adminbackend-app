...
// LaSalle Software
use Lasallesoftware\Librarybackend\Profiles\Models\Lookup_website_type;
...
class OwnersDeleteNotAvailableBecauseUsedInTheProfilieTableTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookupwebsitetypestypes
     * @group novaLookuptablesPoliciesLookupwebsitetypesDelete
     * @group novaLookuptablesPoliciesLookupwebsitetypesDeleteOwnersdeletenotavailablebecauseusedintheprofiletable
     */
    public function testOwnersDeleteNotAvailableBecauseUsedInTheProfilieTable()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookupwebsitetypes\Delete\TestOwnersDeleteNotAvailableBecauseUsedInTheProfileTable**";
    ...
    private function insertTestRecordIntoLookup()
    {
        DB::table('websites')->insert([
            ...
            'lookup_website_type_id' => $this->getLookupTableLastId(),
    ...
    {
        $lookupRecord = Lookup_website_type::orderBy('id', 'desc')->first();
