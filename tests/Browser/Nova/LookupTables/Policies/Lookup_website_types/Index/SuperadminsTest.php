...
namespace Tests\Browser\Nova\LookupTables\Policies\Lookup_website_types\Index;
...
class SuperadminsTest extends LookupTablesBaseDuskTestCase
{
    ...
    /**
     * Test that the a super admin can see Lookup_website_types.
     *
     ...
     * @group novaLookuptablesPoliciesLookupwebsitetypesIndex
     * @group novaLookuptablesPoliciesLookupwebsitetypesIndexSuperadmins
     */
    public function testIndexListingListsSuperadmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookupwebsitetypes\Index\TestSuperadmins**";
