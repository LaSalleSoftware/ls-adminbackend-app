...
class SuperadminsTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookupwebsitetypesUpdateSuperadmins
     */
    public function testIndexListingListsSuperadmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookupwebsitetypes\Update\TestSuperadmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->visit('/nova/resources/Lookup_website_types/7/edit?viaResource=&viaResourceId=&viaRelationship=')
                ->pause($pause['short'])
