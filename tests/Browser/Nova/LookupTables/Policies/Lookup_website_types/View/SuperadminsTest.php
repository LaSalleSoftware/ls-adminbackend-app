...
namespace Tests\Browser\Nova\LookupTables\Policies\Lookup_website_types\View;
...
class SuperadminsTest extends LookupTablesBaseDuskTestCase
{
     ...
     * @group novaLookuptablesPoliciesLookupwebsitetypesView
     * @group novaLookuptablesPoliciesLookupwebsitetypesViewSuperadmins
     */
    public function testIndexListingListsSuperadmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\LookupTables\Policies\Lookupwebsitetypes\View\TestSuperadmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->assertPathIs('/nova')
                ->assertSee('Dashboard')
                ->assertMissing('Lookup Website Types')
                ->visit('/nova/resources/Lookup_website_types/5')
                ->pause($pause['short'])
