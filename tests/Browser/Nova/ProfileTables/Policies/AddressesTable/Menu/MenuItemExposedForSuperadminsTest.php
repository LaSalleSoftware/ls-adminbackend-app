...
namespace Tests\Browser\Nova\ProfileTables\Policies\AddressesTable\Menu;
...
class MenuItemExposedForSuperadminsTest extends ProfileTablesBaseDuskTestCase
{
     ...
     * @group novaprofiletablesPoliciesAddressesMenu
     * @group novaprofiletablesPoliciesAddressesMenuitemsuppressedforowners
     */
    public function testMenuItemExposedForSuperadminsIsSuccessful()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Addresses\Menu\TestMenuItemExposedForSuperadminsIsSuccessful**";
