...
namespace Tests\Browser\Nova\ProfileTables\Policies\AddressesTable\View;
...
class AdminsTest extends ProfileTablesBaseDuskTestCase
{
     ...
     * @group novaprofiletablesPoliciesAddressesView
     * @group novaprofiletablesPoliciesAddressesViewAdmins
     */
    public function testAdmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Addresses\View\TestAdmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->visit('/nova/resources/addresses/1')
                ->pause($pause['long'])
