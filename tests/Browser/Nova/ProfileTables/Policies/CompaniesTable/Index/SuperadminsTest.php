...
class SuperadminsTest extends ProfileTablesBaseDuskTestCase
{
    ...
    /**
     * Test that the a super admin can see lookup_ Company_types.
     *
     ...
     * @group novaprofiletablesPoliciesCompaniesIndexSuperadmins
     */
    public function testIndexListingListsSuperadmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Companies\Index\TestSuperadmins**";
