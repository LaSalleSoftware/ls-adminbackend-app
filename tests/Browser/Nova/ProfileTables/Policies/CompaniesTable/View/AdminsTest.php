...
namespace Tests\Browser\Nova\ProfileTables\Policies\CompaniesTable\View;
...
class AdminsTest extends ProfileTablesBaseDuskTestCase
{
     ...
     * @group novaprofiletablesPoliciesCompaniesView
     * @group novaprofiletablesPoliciesCompaniesViewAdmins
     */
    public function testAdmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Companies\View\TestAdmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->visit('/nova/resources/companies/1')
                ->pause($pause['long'])
