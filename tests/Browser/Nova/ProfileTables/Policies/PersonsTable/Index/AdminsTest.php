...
namespace Tests\Browser\Nova\ProfileTables\Policies\PersonsTable\Index;
...
class AdminsTest extends ProfileTablesBaseDuskTestCase
{
     ...
     * @group novaprofiletablesPoliciesPersonsIndex
     * @group novaprofiletablesPoliciesPersonsIndexAdmins
     */
    public function testAdmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Persons\Index\TestAdmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->visit('/nova/resources/people')
                ->pause($pause['long'])
                ->assertDontSee('Create Person')
                ->assertDontSee('Sidney Bechet')
            ;
        });
    }
}
