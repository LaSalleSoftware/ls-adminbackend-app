...
namespace Tests\Browser\Nova\ProfileTables\Policies\PersonsTable\Menu;
...
class MenuItemSuppressedForAdminsTest extends ProfileTablesBaseDuskTestCase
{
     ...
     * @group novaprofiletablesPoliciesPersonsMenu
     * @group novaprofiletablesPoliciesPersonsMenuitemsuppressedforadmins
     */
    public function testMenuItemSuppressedForAdminsIsSuccessful()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Persons\Menu\TestMenuItemSuppressedForAdminsIsSuccessful**";
