...
namespace Tests\Browser\Nova\ProfileTables\Policies\SocialsTable\Menu;
...
class MenuItemExposedForSuperadminsTest extends ProfileTablesBaseDuskTestCase
{
     ...
     * @group novaprofiletablesPoliciesSocialsMenu
     * @group novaprofiletablesPoliciesSocialsMenuitemsuppressedforowners
     */
    public function testMenuItemExposedForSuperadminsIsSuccessful()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Socials\Menu\TestMenuItemExposedForSuperadminsIsSuccessful**";
