...
namespace Tests\Browser\Nova\ProfileTables\Policies\SocialsTable\View;
...
class AdminsTest extends ProfileTablesBaseDuskTestCase
{
     ...
     * @group novaprofiletablesPoliciesSocialsView
     * @group novaprofiletablesPoliciesSocialsViewAdmins
     */
    public function testAdmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Socials\View\TestAdmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->visit('/nova/resources/socials/1')
                ->pause($pause['long'])
