...
class AdminsTest extends ProfileTablesBaseDuskTestCase
{
     ...
     * @group novaprofiletablesPoliciesTelephonesIndexAdmins
     */
    public function testAdmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Telephones\Index\TestAdmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->visit('/nova/resources/telphones')
                ->pause($pause['long'])
                ->assertDontSee('Create Telephone Number')
                ->assertMissing('@1-row')
                ->assertMissing('@2-row')
            ;
        });
