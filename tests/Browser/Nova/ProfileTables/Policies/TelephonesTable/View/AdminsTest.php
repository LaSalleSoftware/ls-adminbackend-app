...
namespace Tests\Browser\Nova\ProfileTables\Policies\TelephonesTable\View;
...
class AdminsTest extends ProfileTablesBaseDuskTestCase
{
     ...
     * @group novaprofiletablesPoliciesTelephonesView
     * @group novaprofiletablesPoliciesTelephonesViewAdmins
     */
    public function testAdmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Telephones\View\TestAdmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->visit('/nova/resources/telephones/1')
                ->pause($pause['long'])
