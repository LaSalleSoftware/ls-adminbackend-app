...
namespace Tests\Browser\Nova\ProfileTables\Policies\WebsitesTable\Index;
...
class AdminsTest extends ProfileTablesBaseDuskTestCase
{
     ...
     * @group novaprofiletablesPoliciesWebsitesIndex
     * @group novaprofiletablesPoliciesWebsitesIndexAdmins
     */
    public function testAdmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Websites\Index\TestAdmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->assertDontSee('https://www.mlb.com/bluejays')
                ->assertDontSee('https://buffalobills.com')
            ;
        });
    }
}
