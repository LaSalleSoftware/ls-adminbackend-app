...
namespace Tests\Browser\Nova\ProfileTables\Policies\WebsitesTable\View;
...
class AdminsTest extends ProfileTablesBaseDuskTestCase
{
     ...
     * @group novaprofiletablesPoliciesWebsitesView
     * @group novaprofiletablesPoliciesWebsitesViewAdmins
     */
    public function testAdmins()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\Policies\Websites\View\TestAdmins**";
        ...
        $this->browse(function (LaSalleBrowser $browser) use ($login, $pause) {
            $browser
                ...
                ->visit('/nova/resources/websites/1')
                ->pause($pause['long'])
