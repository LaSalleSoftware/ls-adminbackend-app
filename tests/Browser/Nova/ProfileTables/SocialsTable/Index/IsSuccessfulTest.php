...
namespace Tests\Browser\Nova\ProfileTables\SocialsTable\Index;
...
class IsSuccessfulTest extends LaSalleDuskTestCase
{
     ...
     * @group novasocial
     * @group novasocialindexissuccessful
     */
    public function testIndexViewIsSuccessful()
    {
        echo "\n**Now testing Tests\Browser\Nova\ProfileTables\SocialsTable\Index\IsSuccessfulTest**";
