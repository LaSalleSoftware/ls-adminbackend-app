...
class EmergencyBanAllUsersFromLoggingInTest extends TestCase
{
     ...
     * @group LibraryAuthenticationBanusersEmergencyban
     * @group LibraryAuthenticationBanusersEmergencybanIsenabled
     *
     * @return void
     */
    public function testIsEnabled()
    {
        echo "\n**Now testing Tests\Unit\Library\Authentication\BanUsers\EmergencyBanAllUsersFromLoggingInTest**";
     ...
     * @group LibraryAuthenticationBanusers
     * @group LibraryAuthenticationBanusersEmergencyban
     * @group LibraryAuthenticationBanusersEmergencybanIsDisabled
     *
     * @return void
     */
